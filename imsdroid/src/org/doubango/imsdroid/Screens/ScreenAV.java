...
public class ScreenAV extends BaseScreen{
	...
	private final static int MENU_CHANGE_RATE = 6;
	...
	public boolean createOptionsMenu(Menu menu){
		...
		MenuItem itemChangeRate = menu.add(1, ScreenAV.MENU_CHANGE_RATE, 0, "Change Rate").setIcon(R.drawable.image_gallery_48);
		...
		switch(mAVSession.getState()){
			case INCOMING:
			{
				...
				itemChangeRate.setEnabled(false);
				break;
			}
			...
			case INPROGRESS:
			{
				...
				itemShareContent.setEnabled(false);
				itemChangeRate.setEnabled(true);
				break;
			}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch(item.getItemId()){
			...
			case ScreenAV.MENU_CHANGE_RATE:
			{
				//Camera instance;
				//int num;
				
				mAVSession.changeFrameRate(1);
				try
				{
					Camera instance = NgnCameraProducer.getCamera();
					//num = NgnCameraProducer.getNumberOfCameras();
					Camera.Parameters parameters = instance.getParameters();
					//List<Integer> sizes = parameters.getSupportedPreviewFrameRates(); 
					
					//NgnCameraProducer.releaseCamera();
					//instance = NgnCameraProducer.openCamera(5, 176, 144, NgnCameraProducer.getHolder(), NgnCameraProducer.getPreviewCallback());	
					//parameters = instance.getParameters();
					fr = parameters.getPreviewFrameRate();
					int i = fr;
				}
				catch(Exception e)
				{
